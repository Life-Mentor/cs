...
class overall(View):
    def get(self, requests):
        ...
        return render(
            requests,
            "article/overall.html",
            {"catgorys": catgorys, "post_list": post_list, "page_obj": page_obj},
        )
        ...
        if form.is_valid():
            ...
            try:
                ...
                if post_list.exists():
                    ...
                    userpost.save()
            return render(
                requests, "article/author.html", {"forms": form, "code": "发布成功"}
            )
        return render(requests, "article/author.html", {"forms": form})
...
class my_article(View):
    def get(self, requests):
        ...
        if users:
            ...
            return render(
                requests,
                "article/my_article.html",
                {"post_list": post_list, "users": users},
            )
...
class suggestion(View):
    ...
    def post(self, requests):
        ...
        return render(
            ...
            {"form": form, "code": "反馈成功，我们会讨论您所提的建议"},
        )
